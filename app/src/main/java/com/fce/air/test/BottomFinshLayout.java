    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(downY - moveY) > mTouchSlop && Math.abs((int) ev.getRawX() - downX) < mTouchSlop) {
                    return true;
                }
                break;
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                tempY = moveY;
                if (Math.abs(downY - moveY) > mTouchSlop && Math.abs((int) event.getRawY() - downX) < mTouchSlop) {
                    isSilding = true;
                }
