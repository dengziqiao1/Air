...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
      ...
      //by yzj   modify folderName
        String defaultName = launcher.getString(R.string.folder_name);
        Log.i("yzj.launcher", "fromXml==title="+folderInfo.title.length()+"  defaultName="+defaultName);
        if (TextUtils.isEmpty(folderInfo.title)) {
        	 icon.mFolderName.setText(defaultName);
		}
        else {
    ...
    public void onTitleChanged(CharSequence title) {
        String defaultName = getResources().getString(R.string.folder_name);
        Log.i("yzj.launcher", "void onTitleChanged=0000=title="+title.length()+"defaultName="+defaultName);
        if (TextUtils.isEmpty(title.toString())){
            mFolderName.setText(defaultName);
        }else{
