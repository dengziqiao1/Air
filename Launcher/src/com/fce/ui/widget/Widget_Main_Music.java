...
public class Widget_Main_Music extends RelativeLayout implements CarService_Listener, OnClickListener {
...
//	private Widget_Source_BTMusic mBTMusicFragment = null;
	private ImageView mHotMusic;
	private Context mContext;

	public Widget_Main_Music(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = getContext();
...
//		mBTMusicFragment = new Widget_Source_BTMusic();
	...
	protected void onFinishInflate() {
		...
		mHotMusic = (ImageView) this.findViewById(R.id.widget_music_area);
		mHotMusic.setOnClickListener(this);
		// sourceChanged(mIF.getCurSource());
	}
	...
	private void replaceFragment(Fragment fragment) {
		...
		try {
			...
			if (getCurFragment() != fragment) {
				transaction.replace(R.id.widget_music_fragment, fragment);
			}
	...
	private Fragment getCurFragment() {
		Fragment fragment = mFragmentManager.findFragmentById(R.id.widget_music_fragment);
		return fragment;
	}
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case R.id.widget_music_area:
			Intent intent = new Intent();
			PackageManager mPackageManager = mContext.getPackageManager();
			intent = mPackageManager.getLaunchIntentForPackage("com.fce.media");
