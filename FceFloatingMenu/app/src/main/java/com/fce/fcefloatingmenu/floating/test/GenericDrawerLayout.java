...
public class GenericDrawerLayout extends FrameLayout {
     ...
     * 当前抽屉的Gravity
     */
    private int mTouchViewGravity = Gravity.TOP;
    /**
     * 用来防止内容部分视图的容器
     */
    ...
    private void initView() {
        ...
        addView(mContentLayout, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    private class ContentLayout extends FrameLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            child.measure(MeasureSpec.makeMeasureSpec(childMeasureWidth,
    ...
    private boolean isDownInRespondArea(MotionEvent event) {
        ...
        int touchSize;
        touchSize = mOpenedTouchViewSize == ViewGroup.LayoutParams.MATCH_PARENT ?
                mContentLayout.getWidth() : mOpenedTouchViewSize;
        float x = event.getX();
        float y = event.getY();
        switch (mTouchViewGravity) {
            case Gravity.LEFT:
    ...
    public void setContentLayout(View view, LayoutParams layoutParams) {
        mContentLayout.removeAllViews();
    ...
    protected LayoutParams generateTouchViewLayoutParams() {
        LayoutParams lp = (LayoutParams) mTouchView.getLayoutParams();
        if (lp == null) {
